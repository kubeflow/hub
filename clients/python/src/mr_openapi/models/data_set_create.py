...
class DataSetCreate(BaseModel):
    """
    A dataset artifact to be created.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["customProperties", "description", "externalId", "name", "artifactType", "digest", "sourceType", "source", "schema", "profile", "uri", "state"]
