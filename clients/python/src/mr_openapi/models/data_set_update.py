...
class DataSetUpdate(BaseModel):
    """
    A dataset artifact to be updated.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["customProperties", "description", "externalId", "artifactType", "digest", "sourceType", "source", "schema", "profile", "uri", "state"]
