...
class MetadataValue(BaseModel):
    ...
    actual_instance: Optional[Union[MetadataBoolValue, MetadataDoubleValue, MetadataIntValue, MetadataProtoValue, MetadataStringValue, MetadataStructValue]] = None
    one_of_schemas: Set[str] = { "MetadataBoolValue", "MetadataDoubleValue", "MetadataIntValue", "MetadataProtoValue", "MetadataStringValue", "MetadataStructValue" }
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if not _data_type:
            raise ValueError("Failed to lookup data type from the field `metadataType` in the input.")
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], MetadataBoolValue, MetadataDoubleValue, MetadataIntValue, MetadataProtoValue, MetadataStringValue, MetadataStructValue]]:
