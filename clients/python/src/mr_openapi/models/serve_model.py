...
class ServeModel(BaseModel):
    ...
    last_known_state: Optional[ExecutionState] = Field(default=ExecutionState.UNKNOWN, alias="lastKnownState")
    model_version_id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="ID of the `ModelVersion` that was served in `InferenceService`.", alias="modelVersionId")
    __properties: ClassVar[List[str]] = ["customProperties", "description", "externalId", "name", "id", "createTimeSinceEpoch", "lastUpdateTimeSinceEpoch", "lastKnownState", "modelVersionId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lastKnownState": obj.get("lastKnownState") if obj.get("lastKnownState") is not None else ExecutionState.UNKNOWN,
