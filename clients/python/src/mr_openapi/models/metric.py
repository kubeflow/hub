...
class Metric(BaseModel):
    """
    A metric representing a numerical measurement from model training or evaluation.
    """ # noqa: E501
    ...
    step: Optional[StrictStr] = Field(default=None, description="The step number for multi-step metrics (e.g., training epochs).")
    state: Optional[ArtifactState] = ArtifactState.UNKNOWN
    __properties: ClassVar[List[str]] = ["customProperties", "description", "externalId", "name", "id", "createTimeSinceEpoch", "lastUpdateTimeSinceEpoch", "artifactType", "value", "timestamp", "step", "state"]
