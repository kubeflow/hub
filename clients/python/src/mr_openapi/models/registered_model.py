...
class RegisteredModel(BaseModel):
    ...
    description: Optional[StrictStr] = Field(default=None, description="Human-readable description of the model.")
    ...
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The client provided name of the model. It must be unique among all the RegisteredModels of the same type within a Model Registry instance and cannot be changed once set.")
    ...
    __properties: ClassVar[List[str]] = ["customProperties", "description", "externalId", "name", "id", "createTimeSinceEpoch", "lastUpdateTimeSinceEpoch", "readme", "maturity", "language", "tasks", "provider", "logo", "license", "licenseLink", "libraryName", "owner", "state"]
