...
class DataSet(BaseModel):
    """
    A dataset artifact representing training or test data.
    """ # noqa: E501
    ...
    artifact_type: Optional[StrictStr] = Field(default='dataset-artifact', alias="artifactType")
    digest: Optional[StrictStr] = Field(default=None, description="A unique hash or identifier for the dataset content.")
    source_type: Optional[StrictStr] = Field(default=None, description="The type of data source (e.g., \"s3\", \"hdfs\", \"local\", \"database\").", alias="sourceType")
    source: Optional[StrictStr] = Field(default=None, description="The location or connection string for the dataset source.")
    var_schema: Optional[StrictStr] = Field(default=None, description="JSON schema or description of the dataset structure.", alias="schema")
    profile: Optional[StrictStr] = Field(default=None, description="Statistical profile or summary of the dataset.")
    uri: Optional[StrictStr] = Field(default=None, description="The uniform resource identifier of the physical dataset. May be empty if there is no physical dataset.")
    state: Optional[ArtifactState] = ArtifactState.UNKNOWN
    __properties: ClassVar[List[str]] = ["customProperties", "description", "externalId", "name", "id", "createTimeSinceEpoch", "lastUpdateTimeSinceEpoch", "artifactType", "digest", "sourceType", "source", "schema", "profile", "uri", "state"]
