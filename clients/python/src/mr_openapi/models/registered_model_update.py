...
class RegisteredModelUpdate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["customProperties", "description", "externalId", "readme", "maturity", "language", "tasks", "provider", "logo", "license", "licenseLink", "libraryName", "owner", "state"]
