...
class DocArtifact(BaseModel):
    ...
    artifact_type: Optional[StrictStr] = Field(default='doc-artifact', alias="artifactType")
    ...
    __properties: ClassVar[List[str]] = ["customProperties", "description", "externalId", "name", "id", "createTimeSinceEpoch", "lastUpdateTimeSinceEpoch", "artifactType", "uri", "state"]
