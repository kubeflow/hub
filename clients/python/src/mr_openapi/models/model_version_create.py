...
class ModelVersionCreate(BaseModel):
    ...
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The client provided name of the model's version. It must be unique among all the ModelVersions of the same type within a Model Registry instance and cannot be changed once set.")
    ...
    registered_model_id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="ID of the `RegisteredModel` to which this version belongs.", alias="registeredModelId")
    __properties: ClassVar[List[str]] = ["customProperties", "description", "externalId", "name", "state", "author", "registeredModelId"]
