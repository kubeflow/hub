...
class InferenceServiceCreate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["customProperties", "description", "externalId", "name", "modelVersionId", "runtime", "desiredState", "registeredModelId", "servingEnvironmentId"]
