...
class Parameter(BaseModel):
    """
    A parameter representing a configuration parameter used in model training or execution.
    """ # noqa: E501
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name/key of the parameter (e.g., \"learning_rate\", \"batch_size\", \"epochs\").")
    ...
    artifact_type: Optional[StrictStr] = Field(default='parameter', alias="artifactType")
    value: Optional[StrictStr] = Field(default=None, description="The value of the parameter.")
    parameter_type: Optional[ParameterType] = Field(default=None, alias="parameterType")
    state: Optional[ArtifactState] = ArtifactState.UNKNOWN
    __properties: ClassVar[List[str]] = ["customProperties", "description", "externalId", "name", "id", "createTimeSinceEpoch", "lastUpdateTimeSinceEpoch", "artifactType", "value", "parameterType", "state"]
