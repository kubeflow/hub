...
ARTIFACTUPDATE_ONE_OF_SCHEMAS = ["DataSetUpdate", "DocArtifactUpdate", "MetricUpdate", "ModelArtifactUpdate", "ParameterUpdate"]
...
class ArtifactUpdate(BaseModel):
    ...
    oneof_schema_1_validator: Optional[ModelArtifactUpdate] = None
    # data type: DocArtifactUpdate
    oneof_schema_2_validator: Optional[DocArtifactUpdate] = None
    # data type: DataSetUpdate
    oneof_schema_3_validator: Optional[DataSetUpdate] = None
    # data type: MetricUpdate
    oneof_schema_4_validator: Optional[MetricUpdate] = None
    # data type: ParameterUpdate
    oneof_schema_5_validator: Optional[ParameterUpdate] = None
    actual_instance: Optional[Union[DataSetUpdate, DocArtifactUpdate, MetricUpdate, ModelArtifactUpdate, ParameterUpdate]] = None
    one_of_schemas: Set[str] = { "DataSetUpdate", "DocArtifactUpdate", "MetricUpdate", "ModelArtifactUpdate", "ParameterUpdate" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = ArtifactUpdate.model_construct()
        error_messages = []
        match = 0
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in ArtifactUpdate with oneOf schemas: DataSetUpdate, DocArtifactUpdate, MetricUpdate, ModelArtifactUpdate, ParameterUpdate. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in ArtifactUpdate with oneOf schemas: DataSetUpdate, DocArtifactUpdate, MetricUpdate, ModelArtifactUpdate, ParameterUpdate. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into ArtifactUpdate with oneOf schemas: DataSetUpdate, DocArtifactUpdate, MetricUpdate, ModelArtifactUpdate, ParameterUpdate. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ArtifactUpdate with oneOf schemas: DataSetUpdate, DocArtifactUpdate, MetricUpdate, ModelArtifactUpdate, ParameterUpdate. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], DataSetUpdate, DocArtifactUpdate, MetricUpdate, ModelArtifactUpdate, ParameterUpdate]]:
