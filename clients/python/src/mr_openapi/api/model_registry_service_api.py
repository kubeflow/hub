...
class ModelRegistryServiceApi:
    ...
    async def create_environment_inference_service(
        self,
        serving_environment_id: Annotated[str, Field(strict=True, description="A unique identifier for a `ServingEnvironment`.")],
        inference_service_create: Annotated[InferenceServiceCreate, Field(description="A new `InferenceService` to be created.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def create_inference_service_serve(
        self,
        inference_service_id: Annotated[str, Field(strict=True, description="A unique identifier for a `InferenceService`.")],
        serve_model_create: Annotated[ServeModelCreate, Field(description="A new `ServeModel` to be associated with the `InferenceService`.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def create_model_artifact(
        self,
        model_artifact_create: Annotated[ModelArtifactCreate, Field(description="A new `ModelArtifact` to be created.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def create_registered_model(
        self,
        registered_model_create: Annotated[RegisteredModelCreate, Field(description="A new `RegisteredModel` to be created.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def create_registered_model_version(
        self,
        registered_model_id: Annotated[str, Field(strict=True, description="A unique identifier for a `RegisteredModel`.")],
    ...
    async def create_serving_environment(
        self,
        serving_environment_create: Annotated[ServingEnvironmentCreate, Field(description="A new `ServingEnvironment` to be created.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def find_artifact(
        ...
        external_id: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="External ID of entity to search.")] = None,
        parent_resource_id: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="ID of the parent resource to use for search.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def get_artifacts(
        ...
        artifact_type: Annotated[Optional[ArtifactTypeQueryParam], Field(description="Specifies the artifact type for listing artifacts.")] = None,
    ...
    async def get_model_artifact(
        self,
        model_artifact_id: Annotated[str, Field(strict=True, description="A unique identifier for a `ModelArtifact`.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def update_inference_service(
        self,
        inference_service_id: Annotated[str, Field(strict=True, description="A unique identifier for a `InferenceService`.")],
        inference_service_update: Annotated[InferenceServiceUpdate, Field(description="Updated `InferenceService` information.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def update_model_artifact(
        self,
        model_artifact_id: Annotated[str, Field(strict=True, description="A unique identifier for a `ModelArtifact`.")],
        model_artifact_update: Annotated[ModelArtifactUpdate, Field(description="Updated `ModelArtifact` information.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def update_registered_model(
        self,
        registered_model_id: Annotated[str, Field(strict=True, description="A unique identifier for a `RegisteredModel`.")],
        registered_model_update: Annotated[RegisteredModelUpdate, Field(description="Updated `RegisteredModel` information.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def update_serving_environment(
        self,
        serving_environment_id: Annotated[str, Field(strict=True, description="A unique identifier for a `ServingEnvironment`.")],
        serving_environment_update: Annotated[ServingEnvironmentUpdate, Field(description="Updated `ServingEnvironment` information.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def upsert_model_version_artifact(
        self,
        model_version_id: Annotated[str, Field(strict=True, description="A unique identifier for a `ModelVersion`.")],
        artifact: Annotated[Artifact, Field(description="A new or existing `Artifact` to be associated with the `ModelVersion`.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
